...
import OwnersPieChart from "../../../components/charts/OwnersPieChart";
      ...
      <div className={styles.container}>
            ...
            <div className={styles["info-container"]}>
              <div className={styles["line-spacing"]}>
                ...
                <div className={styles["btn-container"]}>
                  <Link href={`/items/${item.archetypeId}/owners`}>
        ...
        <div className={styles["right-side"]}>
          <div className={styles["diagram-container"]}>
            <OwnersPieChart rawData={ownersGrouped} total={item.nfts.length} />
          </div>
        </div>
      </div>
